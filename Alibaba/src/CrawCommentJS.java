...
public class CrawCommentJS {
	...
	public static void main(String args[]) {
		...
		try {
			...
			HttpGet httpget = new HttpGet("http://rate.1688.com/remark/offerDetail/rates.json?_input_charset=GBK&offerId=43546638214&page=1&pageSize=15&starLevel=&orderBy=date&semanticId=&showStat=1&content=1&t=1430970524749&memberId=b2b-2328675150&callback=jQuery172042621358460746706_1430970155652");
			...
			httpget.setHeader("Accept-Language","zh-TW,zh;q=0.8,en-US;q=0.6,en;q=0.4");
			httpget.setHeader("Cookie",props.getProperty("cookie"));
			httpget.setHeader("Referer","http://detail.1688.com/offer/43546638214.html");
			httpget.setHeader("Accept-Encoding","gzip, deflate, sdch");
